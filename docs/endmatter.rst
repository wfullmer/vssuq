...
| :math:`P`              | pressure                                           |
+------------------------+----------------------------------------------------+
| :math:`Q`              | volumetric flow rate                               |
+------------------------+----------------------------------------------------+
| :math:`R_{air}`        | specific gas constant for air                      |
+------------------------+----------------------------------------------------+
| :math:`t`              | time                                               |
+------------------------+----------------------------------------------------+
| :math:`T`              | temperature                                        |
...
| :math:`atm`            | atmosphere                                         |
+------------------------+----------------------------------------------------+
| :math:`F`              | float (rotameter)                                  |
+------------------------+----------------------------------------------------+
| :math:`g`              | gas                                                |
+------------------------+----------------------------------------------------+
| :math:`lab`            | laboratory (conditions)                            |
+------------------------+----------------------------------------------------+
| :math:`obs`            | observed (conditions)                              |
+------------------------+----------------------------------------------------+
| :math:`p`              | particle                                           |
+------------------------+----------------------------------------------------+
| :math:`r`              | rise (through the bed)                             |
+------------------------+----------------------------------------------------+
| :math:`std`            | standard (conditions)                              |
+------------------------+----------------------------------------------------+
| :math:`x`,             |                                                    |
